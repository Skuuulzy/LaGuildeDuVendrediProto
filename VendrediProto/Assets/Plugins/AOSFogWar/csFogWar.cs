...
namespace FischlWorks_FogWar
{
    ...
    public class csFogWar : MonoBehaviour
    {
        ...
        [SerializeField] private List<FogRevealer> fogRevealers = null;
        ...
        [SerializeField] private TextAsset LevelDataToLoad = null;
        ...
        [SerializeField] [Range(1, 300)] private int levelDimensionX = 11;
